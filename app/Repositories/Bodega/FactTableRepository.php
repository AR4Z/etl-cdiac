...
class FactTableRepository extends EloquentRepository implements RepositoriesContract
{
    ...
    public function CountFactTableData($station){
...
//Auditory System Functions
     ...
     * @return array
     */
    public function CountNegativeRisk($station_id,$var,$date1,$date2)
    {
     ...
     * @return array
     */
    public function countFactInOfRange($station_id,$var,$range1,$range2,$date1,$date2)
    {
        return $this->selectRaw('count(estacion_sk)')
            ->where('estacion_sk','=',$station_id)
            ->whereBetween('fecha_sk',[$date1,$date2])
     ...
     * @return array
     */
    public function countFactOutOfRange($station_id,$var,$range1,$range2,$date1,$date2)
    {
        return $this
            ->selectRaw('count(estacion_sk)')
            ->where('estacion_sk','=',$station_id)
            ->whereBetween('fecha_sk',[$date1,$date2])
     ...
     * @return array
     */
    public function NotExistVarForStation($station_id,$var,$date1,$date2){

       return $this
            ->select('count(estacion_sk)')
            ->where('estacion_sk','=',$station_id)
            ->where($var,'>',0)
     ...
     * @return array
     */
    public function ConsecutiveErrors($station_id,$var,$date1,$date2){
       return $this
            ->select($var)
            ->where('estacion_sk','=',$station_id)
     ...
     * @return array
     */
    public function getAverage($station,$var,$date1,$date2){
        return $this
            ->selectRaw("avg($var)")
     ...
     * @return array
     */
    public function getDeviation($station,$var,$date1,$date2){
        return $this
            ->selectRaw("stddev($var)")
            ->where('estacion_sk','=',$station)
            ->whereBetween('fact_table.fecha_sk',[$date1,$date2])
            ->get()->toArray();
    }
     ...
     * @return array
     */
    public function getOutlier($station,$var,$date1,$date2,$date_start,$date_end){
        return $this
            ->select('estacion_sk',$var,'date_dim.año')
     ...
     * @return array
     */
    public function getDates($station,$var,$date1,$date2){
        return $this
            ->select('estacion_sk','fecha_sk',$var)
            ->where('estacion_sk','=',$station)
            ->whereNotNull($var)
            ->whereBetween('fact_table.fecha_sk',[$date1,$date2])
            ->get()->toArray();
     ...
     * @return array
     */
    public function receiveDataWithNullData($station_id,$var,$date1,$date2){
        return $this
            ->selectRaw('count(estacion_sk)')
            ->where('estacion_sk','=',$station_id)
            ->whereBetween('fact_table.fecha_sk',[$date1,$date2])
     ...
     * @return array
     */
    public function receiveData($station_id,$var,$date1,$date2){
        return $this
            ->selectRaw('count(estacion_sk)')
            ->where('estacion_sk','=',$station_id)
            ->whereNotNull($var)
     ...
     * @return array
     */
    public function CountNullData($station_id,$var,$date1,$date2)
    { return $this
        ->selectRaw('count(estacion_sk)')
        ->where('estacion_sk','=',$station_id)
        ->where($var, '=', null )
     ...
     * @return array
     */
    public function evapotranspirationRisk($station_id,$date1,$date2)
    { return $this
        ->selectRaw('count(estacion_sk)')
        ->where('estacion_sk','=',$station_id)
     ...
     * @return array
     */
    public function evapotranspirationNullRisk($station_id,$date1,$date2)
    { return $this
        ->selectRaw('count(estacion_sk)')
        ->where('estacion_sk','=',$station_id)
