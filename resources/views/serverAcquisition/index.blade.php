...
@section('content')
    ...
    <div class="row">
        <div class="page-header">
            <h1>Consulta Servidor de Adquisición </h1>
        </div>
        <div class="col-lg-10 col-lg-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading"><h3 class="panel-title">Configure consulta</h3></div>
                <div class="panel-body">
                    {!! Form::open(['route'=> 'server-acquisition.search-data','method'=> 'POST', 'class'=> 'form-horizontal form-validate floating-label']) !!}
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="form-group {{ $errors->has('station_id') ? ' has-error' : '' }}">
                                {{ Form::label('station_id', 'Estación: ', ['class' => 'col-lg-3 control-label']) }}
                                <div class="col-lg-8">
                                    {!!  Form::select('station_id', $listStation,null,['class' => 'form-control', 'id'=> 'station_id', 'required']) !!}
