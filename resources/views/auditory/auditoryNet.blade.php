            ...
            <div class="panel-body">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="form-group {{ $errors->has('net_id') ? ' has-error' : '' }}">
                        {{ Form::label('net_id', 'Red: ', ['class' => 'col-lg-3 control-label']) }}
                        <div class="col-lg-8">
                            {!!  Form::select('net_id', $net,null,['class' => 'form-control', 'id'=> 'net_id', 'required']) !!}
                            @if ($errors->has('net_id'))
                                <span class="help-block"><strong>{{ $errors->first('net_id') }}</strong></span>
                            @endif
                        </div>
                    </div>
                </div>
